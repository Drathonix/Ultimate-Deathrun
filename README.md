# Ultimate Deathrun Planned Features
Will this project be finished? Who knows.

Ultimate Deathrun - You're gonna Die!

Basic concept: Deathrun with some overall gameplay improvements as well as various gameplay changes that make the game EVEN HARDER!
Everything must be configurable.

Creature Changes:
* Reapers will actually have sonar and can detect you at large distances however they will not attack unless its more convenient.
* Ghost Leviathans will only attack with LOS and only if the player is in their territory.
* All leviathans will receive massive increases to their health and be given damage resistances and vulnerabilities. Attacking leviathans with specific weapons will cause them to run away.
  * All leviathans will be given gas pod immunity (or very high resistance)
  * Ghost leviathans will be damaged more by sharp weapons (knives and prawn drill) but less vulnerable to blunt weapons (prawn fists, propulsed objects)
  * Reapers will be vulnerable to sonic weapons.
  * Sea Dragons have no weaknesses.
* Bone sharks will be less likely to attack at base (there's too many in the base game for these creatures to have increased hostility) they will have increased health to compensate.
* Electric Eels (Forgot the name, will edit later) will have massively reduced health but will drain batteries of items and vehicles.
* All Creatures will have increased hostility depending on radiation levels. Their sight range will be reduced slightly. Sight range reductions will not apply to Reapers due to their sonic abilities.
...
5. 9 hours: max health decreased by 2. Reduced Oxygen Efficiency. More suceptable to all biological debuffs.
6. 12 hours or after reaching 800m (may change): Health regeneration speed reduced. 1% more damage taken. Vision will become slightly foggy and desaturated.
7. 15 hours: Further increase to regeneration delay. Max Health decreased to 90. Regeneration no longer recovers as much health. Movement speed reduction.
...
Radiation Sickness:
Another overlooked aspect of the game. The radiation suit should not be capable of fully protecting against the chernobyl level radiation of the aurora. This will be significantly more deadly the more significant your exposure is.
After the aurora explodes, you have at most 12 hours to seal it before the radiation is fatal to not just you, but all life, this will be sped up by being in more radioactive areas. You will only have an hour at most to seal the aurora before the radiation kills you while inside the aurora.
Util the aurora is sealed, your sickness level will not decrease. 
Once the aurora is sealed, your sickness will improve outside of radioactive areas. Entering radioactive regions will still increase your radiation levels but this will no longer be significant to survival.
The aurora interior will remain radioactive the entire game, being more severe closer to the drive core (before being sealed the entire aurora will have drive core radioactivity) Wearing a radiation suit is a requirement.
...
* Leviathan heavy biomes will have more rare resources and will have unique resources necessary to progression.
 * I may put nickel near specific structures in reaper biomes.
  * Meteorites will have nickel.
* All wrecks will have something useful in them (some currently only have food, water, and decoration items)

Tool Changes:
* Stasis Rifle: Creatures attempting to move in the stasis field will cause it to close quicker. Larger creatures impact this significantly more than smaller ones.
* Propusion Cannon: Creatures take much more damage from launched projectiles. Damage further increased in the prawn suit cannon, will deter leviathans.

Material Additions:
* Muffling Fabric - Used to make silencing tech. 
* Heat Resistant Fabric - Needed to create heat resistant swimwear.
* Plutonium - Obtained from reprocessing depleted reactor fuel rods. Usable for RTG batteries/power cells.
* Cobalt - Appears in Reaper Biomes.

Equipment Additions:
* Reinforced Oxygen Tank -  Improvement to the heavy oxygen tank. Reduces movement speed but grants immunity to Punctured Tanks and adds slight damage resistance.
* Stealth Suit - Reduces creature detection range and muffles bounce back of Reaper sonar. Uses energy from batteries within the inventory. Highly useful in reaper infested areas.

Batteries and Power Cells:
* Weak RTG Battery/Power Cell - Generates power passively from the decay of radioactive materials. Stores the same amount of energy as Lithium Tier. Eventually ceases to generate power due to decay.
* RTG Battery/Power Cell - Generates power passively from the decay of significantly radioactive materials. Stores the same amount of energy as Lithium Tier. Faster than the Weak RTG. Eventually ceases to generate power due to decay.

Reactor Fuels:
* Plutonium Fuel Rod - Generates the same amount of power but lasts half as long.
* Depleted Plutonium Fuel Rod - Reactor byproduct. Highly radioactive. (May consider using in the rocket recipe)

Item Changes:
* Depleted Reactor Fuel: 
 * Causes radiation sickness without a radiation suit.
 * Can be reprocessed for advanced materials.
  
Vehicle Changes:
* Vehicle lights will drain power and alert creatures. This negates any LOSD stealth systems 
 * This applies to camera lights as well.
* Vehicle Modules
 * Prawn Drill Arm MkII - Mines quicker and is capable of drilling Kyanite.
 * Vehicle Silence Module - (LOSD STEALTH) Applies to Seamoth and Prawn suit. Reduces noise, reducing creature detection range.
 * Vehicle Cloaking Module - (ROD STEALTH) Makes the vehicle practically invisible to nearby creatures.

Rocket Changes:
* More difficult to build.
 * Will not be nearly as grindy as the Realistic Rocket mod but still massively changed.
 * Needs:
  * Warp Drive
  * Power Core
  * Shield
